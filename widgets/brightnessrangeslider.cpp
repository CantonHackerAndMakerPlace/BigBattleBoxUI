...
#include "brightnessrangeslider.h"

class BrightnessRangeSliderPrivate
{
    Q_DECLARE_PUBLIC(BrightnessRangeSlider);
protected:
    BrightnessRangeSlider *const q_ptr;
public:
    ...
    BrightnessRangeSliderPrivate(BrightnessRangeSlider& object);
    void init();
    ...
    BrightnessRangeSliderPrivate::Handles m_SelectedHandles;
...
private:
    Q_DISABLE_COPY(BrightnessRangeSliderPrivate);
};

// --------------------------------------------------------------------------
BrightnessRangeSliderPrivate::BrightnessRangeSliderPrivate(BrightnessRangeSlider& object)
    : q_ptr(&object)
{
    this->m_MinimumValue = 0;
    this->m_MaximumValue = 255;
    this->m_MinimumPosition = 0;
    this->m_MaximumPosition = 255;
...
// --------------------------------------------------------------------------
void BrightnessRangeSliderPrivate::init()
{
    Q_Q(BrightnessRangeSlider);
...
// --------------------------------------------------------------------------
BrightnessRangeSliderPrivate::Handle BrightnessRangeSliderPrivate::handleAtPos(const QPoint& pos, QRect& handleRect)const
{
    Q_Q(const BrightnessRangeSlider);
...
//
int BrightnessRangeSliderPrivate::pixelPosToRangeValue(int pos) const
{
    Q_Q(const BrightnessRangeSlider);
    QStyleOptionSlider option;
    q->initStyleOption(&option);
...
//---------------------------------------------------------------------------
int BrightnessRangeSliderPrivate::pixelPosFromRangeValue(int val) const
{
    Q_Q(const BrightnessRangeSlider);
    QStyleOptionSlider option;
    q->initStyleOption(&option);
...
void BrightnessRangeSliderPrivate::drawMinimumSlider(QStylePainter *painter) const
{
    Q_Q(const BrightnessRangeSlider);
    QStyleOptionSlider option;
...
void BrightnessRangeSliderPrivate::drawMaximumSlider(QStylePainter *painter) const
{
    Q_Q(const BrightnessRangeSlider);
    QStyleOptionSlider option;
...
// --------------------------------------------------------------------------
BrightnessRangeSlider::BrightnessRangeSlider(QWidget *_parent)
    : QSlider(_parent)
    , d_ptr(new BrightnessRangeSliderPrivate(*this))
{
    Q_D(BrightnessRangeSlider);
    d->init();
}

// --------------------------------------------------------------------------
BrightnessRangeSlider::BrightnessRangeSlider(Qt::Orientation o,
...
// --------------------------------------------------------------------------
BrightnessRangeSlider::BrightnessRangeSlider(BrightnessRangeSliderPrivate *impl, QWidget *_parent)
    : QSlider(_parent)
    , d_ptr(impl)
{
    Q_D(BrightnessRangeSlider);
...
// --------------------------------------------------------------------------
BrightnessRangeSlider::BrightnessRangeSlider(BrightnessRangeSliderPrivate *impl, Qt::Orientation o,
                               QWidget *parentObject)
    : QSlider(o, parentObject)
    , d_ptr(impl)
{
...
// --------------------------------------------------------------------------
BrightnessRangeSlider::~BrightnessRangeSlider()
{
}

// --------------------------------------------------------------------------
int BrightnessRangeSlider::minimumValue() const
{
    Q_D(const BrightnessRangeSlider);
    return d->m_MinimumValue;
}

// --------------------------------------------------------------------------
void BrightnessRangeSlider::setMinimumValue(int min)
{
    Q_D(BrightnessRangeSlider);
...
// --------------------------------------------------------------------------
int BrightnessRangeSlider::maximumValue() const
{
    Q_D(const BrightnessRangeSlider);
...
// --------------------------------------------------------------------------
void BrightnessRangeSlider::setMaximumValue(int max)
{
    Q_D(BrightnessRangeSlider);
...
// --------------------------------------------------------------------------
void BrightnessRangeSlider::setValues(int l, int u)
{
    Q_D(BrightnessRangeSlider);
...
// --------------------------------------------------------------------------
int BrightnessRangeSlider::minimumPosition() const
{
    Q_D(const BrightnessRangeSlider);
...
// --------------------------------------------------------------------------
int BrightnessRangeSlider::maximumPosition() const
{
    Q_D(const BrightnessRangeSlider);
...
// --------------------------------------------------------------------------
void BrightnessRangeSlider::setMinimumPosition(int l)
{
    Q_D(const BrightnessRangeSlider);
...
// --------------------------------------------------------------------------
void BrightnessRangeSlider::setMaximumPosition(int u)
{
    Q_D(const BrightnessRangeSlider);
...
// --------------------------------------------------------------------------
void BrightnessRangeSlider::setPositions(int min, int max)
{
    Q_D(BrightnessRangeSlider);
...
// --------------------------------------------------------------------------
void BrightnessRangeSlider::setSymmetricMoves(bool symmetry)
{
    Q_D(BrightnessRangeSlider);
...
// --------------------------------------------------------------------------
bool BrightnessRangeSlider::symmetricMoves()const
{
    Q_D(const BrightnessRangeSlider);
...
// --------------------------------------------------------------------------
void BrightnessRangeSlider::onRangeChanged(int _minimum, int _maximum)
{
    Q_UNUSED(_minimum);
    Q_UNUSED(_maximum);
    Q_D(BrightnessRangeSlider);
...
// --------------------------------------------------------------------------
// Render
void BrightnessRangeSlider::paintEvent(QPaintEvent *)
{
    Q_D(BrightnessRangeSlider);
    QStyleOptionSlider option;
...
void BrightnessRangeSlider::mousePressEvent(QMouseEvent* mouseEvent)
{
    Q_D(BrightnessRangeSlider);
    ...
    QRect handleRect;
    BrightnessRangeSliderPrivate::Handle handle_ = d->handleAtPos(mouseEvent->pos(), handleRect);

    if (handle_ != BrightnessRangeSliderPrivate::NoHandle)
    {
        d->m_SubclassPosition = (handle_ == BrightnessRangeSliderPrivate::MinimumHandle) ?
        ...
        mepos > minCenter && mepos < maxCenter)
    {
        ...
        {
            d->m_SelectedHandles =
                QFlags<BrightnessRangeSliderPrivate::Handle>(BrightnessRangeSliderPrivate::MinimumHandle) |
                QFlags<BrightnessRangeSliderPrivate::Handle>(BrightnessRangeSliderPrivate::MaximumHandle);
...
// --------------------------------------------------------------------------
// Standard Qt UI events
void BrightnessRangeSlider::mouseMoveEvent(QMouseEvent* mouseEvent)
{
    Q_D(BrightnessRangeSlider);
...
void BrightnessRangeSlider::mouseReleaseEvent(QMouseEvent* mouseEvent)
{
    Q_D(BrightnessRangeSlider);
    this->QSlider::mouseReleaseEvent(mouseEvent);

    setSliderDown(false);
    d->m_SelectedHandles = BrightnessRangeSliderPrivate::NoHandle;

    this->update();
}

// --------------------------------------------------------------------------
bool BrightnessRangeSlider::isMinimumSliderDown()const
{
    Q_D(const BrightnessRangeSlider);
    return d->m_SelectedHandles & BrightnessRangeSliderPrivate::MinimumHandle;
}

// --------------------------------------------------------------------------
bool BrightnessRangeSlider::isMaximumSliderDown()const
{
    Q_D(const BrightnessRangeSlider);
    return d->m_SelectedHandles & BrightnessRangeSliderPrivate::MaximumHandle;
}

// --------------------------------------------------------------------------
void BrightnessRangeSlider::initMinimumSliderStyleOption(QStyleOptionSlider* option) const
{
    this->initStyleOption(option);
}

// --------------------------------------------------------------------------
void BrightnessRangeSlider::initMaximumSliderStyleOption(QStyleOptionSlider* option) const
{
    this->initStyleOption(option);
}

// --------------------------------------------------------------------------
QString BrightnessRangeSlider::handleToolTip()const
{
    Q_D(const BrightnessRangeSlider);
...
// --------------------------------------------------------------------------
void BrightnessRangeSlider::setHandleToolTip(const QString& _toolTip)
{
    Q_D(BrightnessRangeSlider);
...
// --------------------------------------------------------------------------
bool BrightnessRangeSlider::event(QEvent* _event)
{
    Q_D(BrightnessRangeSlider);
    switch(_event->type())
    {

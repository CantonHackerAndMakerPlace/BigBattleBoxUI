#ifndef BRIGHTNESSRANGESLIDER_H
#define BRIGHTNESSRANGESLIDER_H
...
class BrightnessRangeSlider : public QSlider
{
    Q_OBJECT
...
public:
    ...
    /// Constructor, builds a BrightnessRangeSlider that ranges from 0 to 100 and has
    /// a lower and upper values of 0 and 100 respectively, other properties
    /// are set the QSlider default properties.
    explicit BrightnessRangeSlider(Qt::Orientation o, QWidget *par= 0);
    explicit BrightnessRangeSlider(QWidget *par = 0);
    virtual ~BrightnessRangeSlider();
...
protected:
    BrightnessRangeSlider(BrightnessRangeSliderPrivate *impl, Qt::Orientation o, QWidget *par= 0);
    BrightnessRangeSlider(BrightnessRangeSliderPrivate *impl, QWidget *par = 0);
...
protected:
    QScopedPointer<BrightnessRangeSliderPrivate> d_ptr;

private:
    Q_DECLARE_PRIVATE(BrightnessRangeSlider);
    Q_DISABLE_COPY(BrightnessRangeSlider);
};

...
BlinkConfig::BlinkConfig(QString const& settingKeyPrefix,QObject *parent)
    ...
    , m_onDuration(500, settingKeyPrefix +"/blink/numberOfBlinks")
    , m_offDuration(500, settingKeyPrefix +"/blink/numberOfBlinks")
    , m_unified(true, settingKeyPrefix +"/blink/numberOfBlinks")
    , m_p1OnColor(Qt::green, settingKeyPrefix +"/blink/numberOfBlinks")
    , m_p1OnBrightness(100, settingKeyPrefix +"/blink/numberOfBlinks")
    , m_p1OffColor(Qt::blue,settingKeyPrefix +"/blink/numberOfBlinks")
    , m_p1OffBrightness(100, settingKeyPrefix +"/blink/numberOfBlinks")
    , m_p2OnColor(Qt::magenta, settingKeyPrefix +"/blink/numberOfBlinks")
    , m_p2OnBrightness(100, settingKeyPrefix +"/blink/numberOfBlinks")
    , m_p2OffColor(Qt::yellow, settingKeyPrefix +"/blink/numberOfBlinks")
    , m_p2OffBrightness(100, settingKeyPrefix +"/blink/numberOfBlinks")
{ }
